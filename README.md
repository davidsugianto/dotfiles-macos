...
| [sofka](https://sofka.rs) | Kubernetes TUI (Rust, k9s-inspired) — Flux/Argo CD built in, native incident view, themed Catppuccin Mocha, matching WezTerm/Neovim/k9s (`sofka/`) |
